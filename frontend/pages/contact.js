...
export const ContactUs = () => {
  ...
  return (
    <Wrapper className="grid-cols-1 max-w-[600px] pt-20 pb-32">
      <form ref={form} onSubmit={sendEmail} className="grid grid-cols-1 gap-6 bg-white p-6 rounded-md">
        ...
        <button type="submit" className="w-full py-4 rounded-full bg-black text-white text-lg font-medium transition-transform active:scale-95 mb-3 hover:opacity-75 flex items-center gap-2 justify-center">
          Send Message
        </button>
      </form>
      <ToastContainer />
