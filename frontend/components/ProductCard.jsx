...
const ProductCard = ({ children, className, condition }) => {
  return (
    <div className="transform duration-200 hover:scale-105">
      <Link href="/product/1" className="overflow-hidden bg-grey cursor-pointer">

        {condition === 1 &&(
          <img className="w-full bg-black/[0.1] p-3 sm:p-5" src="/react-logo.png" alt="Product Image" />
         )}
        {condition === 2 &&(
          <img className="w-full bg-black/[0.1]" src="/tailwind-logo.svg" alt="Product Image" />
        )}
        {condition === 3 &&(
          <img className="w-full bg-black/[0.1] p-3 sm:p-5" src="/next-logo.png" alt="Product Image" />
        )}
